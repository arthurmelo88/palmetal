...
ALTER TABLE c_bpartner  ADD CONSTRAINT c_bpartner_lbr_bptypebrisvalid_check CHECK (lbr_bptypebrisvalid = ANY (ARRAY['Y'::bpchar, 'N'::bpchar]));
...
ALTER TABLE c_bpartner_location  ALTER COLUMN lbr_cnpj TYPE VARCHAR(14) ;
